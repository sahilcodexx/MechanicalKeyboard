    ...
    >
      ...
      <div className="w-full flex-1 flex flex-col lg:flex-row items-start min-h-screen">
              ...
              {installTab === "cli" ? (
                ...
                <div className="space-y-8 pt-2">
                  ...
                  <div className={`space-y-3 pl-4 border-l-2 ${isDark ? "border-neutral-700" : "border-neutral-300"}`}>
                    ...
                    >
                      <span className="font-mono">npm i motion clsx tailwind-merge @tabler/icons-react lucide-react</span>
                      <button
                  ...
                  <div className={`space-y-3 pl-4 border-l-2 ${isDark ? "border-neutral-700" : "border-neutral-300"}`}>
                    ...
                    >
                      <button
                        onClick={() => copyToClipboard(manualSourceCode, "src-code")}
        ...
        >
          ...
          <div
            className={`inline-flex items-center rounded-full border p-1 shadow-lg z-10 ${
